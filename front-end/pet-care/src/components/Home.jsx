  ...
  const services = [
    {
      ...
      description: "Regular wellness exams to ensure your pet's overall health, detect early signs of illness, and maintain their well-being.",
    },
    {
      icon: "💉",
      title: "Vaccination",
      description: "Comprehensive vaccination programs to protect your pets from common and preventable diseases.",
    },
    {
      icon: "✂️",
      title: "Grooming",
    ...
    },
    {
      ...
      description: "Thorough dental care and cleaning to prevent plaque buildup, gum disease, and bad breath in your pets.",
    },
    {
      icon: "🚑",
      title: "Emergency Visit",
      description: "Immediate care for urgent medical conditions because your pet's health can't wait.",
    },
  ];
    ...
    <div className="app">
      ...
      <section id="services" className="services">
        <div className="services-content">
          ...
          {/* Grid Version (fallback for mobile) */}
          ...
          <div className="app-content">
            ...
            <div className="image-section">
              ...
              <div className="image-frame" style={{ backgroundImage: `url(${car})` }}>
                <img className="app-image" alt="Appointment" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="about-content">
          ...
          <div className="ab-image-section">
            <div className="ab-image-frame" style={{ backgroundImage: `url(${about})` }}>
              <img className="ab-app-image" alt="About PetCare" />
            </div>
          </div>
        </div>
      </section>
